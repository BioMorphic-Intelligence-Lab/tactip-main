...
def csv_row_to_label(row):
   ...
   row_dict = {label: np.array(row[label]) for label in all_labels}
   return row_dict
...
def setup_model_labels(task_name, data_dirs, save_dir=None):
   ...
   for data_dir in data_dirs:
       ...
       llims.append(collect_params['pose_llims'] + collect_params['shear_llims'] + collect_params['ft_llims'])
   ...
   model_label_params = {
       ...
       'label_names': POSE_LABEL_NAMES+SHEAR_LABEL_NAMES+FT_LABEL_NAMES,
